...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "cafoga" => "camiloforerogalindo@hotmail.es" }
  # Or just: spec.author    = "cafoga"
  # spec.authors            = { "cafoga" => "camiloforerogalindo@hotmail.es" }
  # spec.social_media_url   = "https://twitter.com/cafoga"
